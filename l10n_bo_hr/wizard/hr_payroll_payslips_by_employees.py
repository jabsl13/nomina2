...
class HrPayslipEmployees(models.TransientModel):
    ...
    structure_type_id = fields.Many2one('hr.payroll.structure.type', string='Tipo estructura salarial', required=True)
    ...
    def compute_sheet(self):
        ...
        ).filtered(lambda c: c.active and c.structure_type_id.id == self.structure_type_id.id)
